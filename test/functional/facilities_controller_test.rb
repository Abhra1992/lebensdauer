...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { close: @facility.close, name: @facility.name, open: @facility.open, registration: @facility.registration }
    end
  ...
  test "should update facility" do
    put :update, id: @facility, facility: { close: @facility.close, name: @facility.name, open: @facility.open, registration: @facility.registration }
    assert_redirected_to facility_path(assigns(:facility))
  end
