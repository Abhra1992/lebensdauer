...
class MedicalRecordsControllerTest < ActionController::TestCase
  ...
  test "should create medical_record" do
    assert_difference('MedicalRecord.count') do
      post :create, medical_record: { closure: @medical_record.closure, comments: @medical_record.comments, onset: @medical_record.onset }
    end
  ...
  test "should update medical_record" do
    put :update, id: @medical_record, medical_record: { closure: @medical_record.closure, comments: @medical_record.comments, onset: @medical_record.onset }
    assert_redirected_to medical_record_path(assigns(:medical_record))
  end
