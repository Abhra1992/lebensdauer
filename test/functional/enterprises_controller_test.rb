...
class EnterprisesControllerTest < ActionController::TestCase
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post :create, enterprise: { email: @enterprise.email, fax: @enterprise.fax, name: @enterprise.name, registration: @enterprise.registration }
    end
  ...
  test "should update enterprise" do
    put :update, id: @enterprise, enterprise: { email: @enterprise.email, fax: @enterprise.fax, name: @enterprise.name, registration: @enterprise.registration }
    assert_redirected_to enterprise_path(assigns(:enterprise))
  end
