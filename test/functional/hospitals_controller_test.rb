...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { availability: @hospital.availability, capacity: @hospital.capacity, name: @hospital.name }
    end
  ...
  test "should update hospital" do
    put :update, id: @hospital, hospital: { availability: @hospital.availability, capacity: @hospital.capacity, name: @hospital.name }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
